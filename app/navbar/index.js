...
export default class Navbar extends Component {
  ...
  render() {
    return (
      <section id="navigation" className="container">
        ...
        <ul id="auth" className="navbar-nav navbar-right">
          <li>{!this.props.user && <Link id="sign-up" to={'/newuser'}><i className="fa fa-plus"></i><i className="fa fa-user-circle-o"></i></Link> }
          </li>
          <li>
            <Link className="fa fa-sign-in fa-lg" data-toggle="modal" data-target="#myModal"></Link>
          </li>
          <li>
